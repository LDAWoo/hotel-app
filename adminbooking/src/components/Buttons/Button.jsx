...
function Button({ className, background, border, classIcon, active, icon, classTitle, title, size, customSize, disabled, classImg, src, srcDark, srcSet, srcSetDark, alt, onClick, iconPosition, srcPosition, titlePosition, fontBold, fontMedium, xxxl, xxl, xl, large, medium, small, nowrap, titleCustom }) {
  return (
    <button
      ...
      onClick={onClick}
    >
      <div className={`${title ? "justify-start" : "item-center flex-grow justify-center"} ml-2 mr-2 flex items-center gap-2 w-full`}>
