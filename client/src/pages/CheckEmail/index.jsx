      ...
      <div className='w-full sm:w-[446px] md:w-[380px]'>
        <div className='flex flex-col text-center items-center justify-center w-full'>
          <Title
            ...
            nowrap={false}
            fontBold
            className='text-[32px] sm:text-[36px] text-hotel-100 mb-8'
          />
          <Title
          ...
          <Button
            title={t("CheckEmail.backLogin")}
            classTitle='text-hotel-100 text-center'
            fontBold
            xxl
