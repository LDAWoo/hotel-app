  ...
  return (
    <div className='w-full h-full'>
      <div className='flex flex-col'>
        <Title
          title={t("ForgotConfirmation.title")}
          extraLarge4
          nowrap={false}
          fontBold
        ...
        <div>
          <Title
            title={t("ForgotConfirmation.subTitle1")}
            xl
            nowrap={false}
            className=' dark:text-white mb-5'
          />{" "}
          <strong className='text-[14px]'>{encodedEmail}</strong>
          {". "}
          <Title
            title={t("ForgotConfirmation.subTitle2")}
            xl
            nowrap={false}
            className=' dark:text-white mb-5'
          />
      ...
      <Link to={routesConfig.login}>
        <Button
          ...
          title={t("ForgotConfirmation.backLogin")}
        />
      </Link>
