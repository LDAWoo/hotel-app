...
function TrendingDestination({ loading }) {
  ...
  const trendingDestinations = [
    {
      id: 1,
      destination: t("TrendingDestination.locations.HaNoi"),
    ...
    {
      id: 2,
      destination: t("TrendingDestination.locations.DaNang"),
    ...
    {
      id: 3,
      destination: t("TrendingDestination.locations.NhaTrang"),
    ...
    {
      id: 4,
      destination: t("TrendingDestination.locations.VungTau"),
    ...
    {
      id: 5,
      destination: t("TrendingDestination.locations.HoChiMinh"),
