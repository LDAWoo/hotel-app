      ...
      <div className='max-w-[500px] flex flex-col h-full justify-between'>
        <div className='relative'>
          <div className='flex flex-col p-4 gap-2'>
            <Title title={title} nowrap={false} extraLarge4 />
            <Title title={subTitle} nowrap={false} xxl />
          </div>
        </div>
      </div>
      <div className='flex flex-col mr-0 sm:mr-[30%] 2md:mr-0 2md:flex-row gap-5 p-4'>
        {ComponentLeft && (
          <div className='flex flex-col gap-5 w-full 2md:w-[45%]'>
            <div
              className={`w-full gap-5 p-4 bg-white border rounded-sm ${classComponentLeft}`}
            >
              {ComponentLeft}
            </div>
