...
function Login() {
  ...
  return (
    <div className={`${darkMode}`} >
        <div className={`flex justify-center p-[48px] bg-gray-50 dark:bg-primary-700`} style={{ minHeight: heightWindow }}>
          <div className="min-w[296px] w-full sm:w-[446px] md:w-[310px]">
              ...
              <div className="text-[32px] sm:text-[48px] md:text-[56px] font-bold dark:text-white mb-5">{t('Login.title')}</div>
              <div className="pb-8">
                  <div className="text-[16px] sm:text-[18px] md:text-[22px] font-medium dark:text-white mb-4">{t('Login.loginWithOpenAccount')}</div>
              ...
              <div className="flex flex-col w-full space-y-4 pt-8">
                  <div className="font-medium dark:text-white text-[16px]">{t('Login.orContinueWithEmail')}</div>
                  <TextInput 
                  className=""
              ...
              <div className="flex items-center mt-8">
                <div className="text-gray-500 font-medium">{t('Login.doNotHaveAnAccount')}</div>
                <Link 
