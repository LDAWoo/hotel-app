...
function Entry({onConfirm}) {
    ...
    return ( 
        <div className="min-w[296px] w-full sm:w-[446px] md:w-[310px]">
            <div className="text-[32px] sm:text-[48px] md:text-[56px] font-bold dark:text-white mb-5">{t('Register.title')}</div>
            <div className="pb-8">
                <Link to="/">
                <Image 
                ...
                <div className="text-[16px] sm:text-[18px] md:text-[22px] font-medium dark:text-white mb-4">{t('Register.registerWithOpenAccount')}</div>
            ...
            <div className="flex flex-col w-full space-y-4 pt-8">
                <div className="font-medium dark:text-white text-[16px]">{t('Register.orContinueWithEmail')}</div>
                <TextInput 
            ...
            <div className="flex items-center mt-8">
              <div className="text-gray-500 font-medium">{t('Register.alreadyAMember')}</div>
              <Link 
