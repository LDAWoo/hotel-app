      ...
      <div className="flex items-center w-full mb-[0.125rem] min-h-[1.5rem] pl-[1.5rem]">
        <div className="flex items-center flex-1">
          <input
            ...
            checked={checked}
          />
          <label className="inline-block text-[14px] pl-[0.15rem] hover:cursor-pointer" htmlFor={value}>
            {title}
          </label>
        </div>
