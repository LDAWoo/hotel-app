  ...
  return (
    <div className="w-full h-full">
      <div className="flex flex-col">
        <Title title={t("RegisterPassword.title")} extraLarge4 nowrap={false} fontBold className=" dark:text-white" />
        <Title title={t("RegisterPassword.subTitle")} xl nowrap={false} className=" dark:text-white mb-5" />
      </div>
